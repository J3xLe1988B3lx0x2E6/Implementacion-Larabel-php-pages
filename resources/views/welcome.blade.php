...
<body class="body-welcome p-3 center">
	<div class="welcome-foto welcome-foto_login mx-auto mt-3 mt-md-5 mt-lg-3" style="margin-bottom: 3vw;">
		<img src="{{asset('img/robotitus.png')}}" alt="" style="width: 100%">
	</div>
	<h1 class="text-center mt-4 pt-2"><span>Robotitus pagina de noticias cientificas</span></h1>
